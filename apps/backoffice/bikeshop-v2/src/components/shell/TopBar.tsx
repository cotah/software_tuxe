...
import { BarChart3, Bell, Brain, Calendar, Home, Search, Users, Wrench } from 'lucide-react'
      ...
      <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between px-6">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <span className="hidden md:inline rounded border border-border px-1.5 text-xs text-muted-foreground">
              Ctrl+K
            </span>
          </Button>
