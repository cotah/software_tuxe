...
import { LayoutDashboard, FileText, Plus, Bike, Search, Calendar, Users, BarChart3, Package, Bot, Brain } from 'lucide-react'
import {
  CommandDialog,
  CommandEmpty,
  CommandGroup,
    ...
    <CommandDialog open={isOpen} onOpenChange={(open) => !open && close()}>
      ...
      <CommandList>
        ...
        <CommandGroup heading="Navegação">
          ...
          <CommandItem onSelect={() => navigateTo('/agenda')}>
          ...
          <CommandItem onSelect={() => navigateTo('/ai')}>
          ...
          <CommandItem onSelect={() => navigateTo('/robots')}>
